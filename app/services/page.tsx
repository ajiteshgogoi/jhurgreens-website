        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              JhurGreens International offers comprehensive sourcing solutions to help your business thrive in the global marketplace.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Comprehensive Sourcing Solutions</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              We provide end-to-end services to streamline your global sourcing operations, helping you save time, reduce costs and minimize risks.
            </p>
